...
zip out/E8_3D-KitKat-compatibility-rc1_rev${build}.zip META-INF system specific build_prop_patcher.sh boot_*.img -r
echo out/E8_3D-KitKat-compatibility-rc1_rev${build}.zip built
zip out/E8_3D-KitKat-compatibility-rc1_rev${build}_helpers.zip aml_autoscript Init_FS_after_NAND_scrub.zip u-boot.bin
echo out/E8_3D-KitKat-compatibility-rc1_rev${build}_helpers.zip built
...
until adb push out/E8_3D-KitKat-compatibility-rc1_rev${build}.zip /sdcard/; do sleep 1 ; done
#until adb push out/E8_3D-KitKat-compatibility-rc1_rev${build}.zip /media/; do sleep 1 ; done
